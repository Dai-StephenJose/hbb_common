...
pub const RENDEZVOUS_SERVERS: &[&str] = &["36.249.58.223"];
pub const RS_PUB_KEY: &str = "Uhou+tgg+9dIyB77rIi0C9hCvHdgiW84pPLUNQ1CJxE=";

pub const RENDEZVOUS_PORT: i32 = 30006;
pub const RELAY_PORT: i32 = 30007;
pub const WS_RENDEZVOUS_PORT: i32 = 30008;
pub const WS_RELAY_PORT: i32 = 30009;
